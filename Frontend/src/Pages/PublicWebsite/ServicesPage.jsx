...
const services = [
  {
    icon: Utensils,
    title: "Room Service",
    desc: "24-hour in-room dining with an extensive menu crafted by our executive chef. Enjoy gourmet meals delivered to your door.",
  },
  {
    icon: WashingMachine,
    title: "Laundry & Dry Cleaning",
    desc: "Same-day laundry and professional dry cleaning services available for all guests. Express service available.",
  },
  {
    icon: AlarmClock,
    title: "Wake-up Call",
    desc: "Never miss an important meeting or flight. Our friendly staff will give you a personalized wake-up call.",
  },
  {
    icon: UtensilsCrossed,
    title: "Fine Dining Restaurant",
    desc: "Experience culinary excellence at our signature restaurant serving international and local cuisine.",
  },
  {
    icon: Wrench,
    title: "Maintenance",
    desc: "Prompt maintenance support for any in-room issues. Submit requests via our app or front desk.",
  },
  {
    icon: Car,
    title: "Airport Transfers",
    desc: "Comfortable and reliable airport pickup and drop-off with professional drivers and premium vehicles.",
  },
  {
    icon: Waves,
    title: "Spa & Pool",
    desc: "Rejuvenate at our world-class spa and temperature-controlled infinity pool with stunning views.",
  },
  {
    icon: Dumbbell,
    title: "Fitness Center",
    desc: "State-of-the-art gym open 24/7 with modern equipment and personal trainer sessions available.",
  },
  {
    icon: Phone,
    title: "Concierge",
    desc: "Your personal concierge handles reservations, recommendations and arrangements to make your stay seamless.",
  },
];
            ...
            <div key={i} className={`p-6 rounded-2xl border transition-all duration-300 hover:shadow-lg hover:-translate-y-1 ${
              ...
              <div
                className={`w-14 h-14 rounded-xl flex items-center justify-center mb-5 transition-colors ${
                  dark ? "bg-[#cbb19d]/10" : "bg-[#faf8f6]"
                }`}
              >
                <s.icon
                  size={24}
                  className={dark ? "text-[#cbb19d]" : "text-[#9a836c]"}
                />
              </div>
