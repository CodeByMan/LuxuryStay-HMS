          ...
          <div className="footer-col">
            ...
            <ul className="space-y-4">
              <li className="flex gap-3 items-start">
                ...
                <span className={`text-sm ${dark ? "text-gray-400" : "text-gray-500"}`}>123 Luxury Lane, Downtown, City 00001</span>
              </li>
              <li className="flex gap-3 items-center">
                <Phone size={16} className="text-[#cbb19d] flex-shrink-0" />
                <span className={`text-sm ${dark ? "text-gray-400" : "text-gray-500"}`}>+1 (000) 123-4567</span>
              </li>
              <li className="flex gap-3 items-center">
                <Mail size={16} className="text-[#cbb19d] flex-shrink-0" />
                <span className={`text-sm ${dark ? "text-gray-400" : "text-gray-500"}`}>info@luxurystay.com</span>
              </li>
            </ul>
          </div>
        </div>
